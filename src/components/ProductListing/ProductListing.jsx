          ...
          <div className="rightContent w-full lg:w-[80%] py-3 px-2">
            <div className="bg-[#f1f1f1] p-2 w-full mb-3 flex items-center justify-between rounded-md">
              <div className="col1 flex items-center itemViewActions">
                <Button className={`!w-[35px] !h-[35px] !min-w-[35px] !rounded-full ${itemView === "grid" && 'active'}`} onClick={()=>setItemView('grid')}>
                  <IoGrid className="!text-[rgba(0,0,0,0.7)] text-[14px]" />
                </Button>
                <Button className={`!w-[35px] !h-[35px] !min-w-[35px] !rounded-full ${itemView === "list" && 'active'}`} onClick={()=>setItemView('list')}>
            ...
            <div className={`grid ${itemView==='grid' ? 'grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5' : 'grid-cols-1'} gap-4`}>
              {
                itemView === "grid" ? 
               <>
                  <ProductItem />
